...
assetsRouter.post(
  ...
  body('OwnerId', 'must be a string').notEmpty(),
  body('OwnerContact', 'must be a string').notEmpty(),
  body('State', 'must be a string').notEmpty(),
  body('City', 'must be a string').notEmpty(),
  body('Pin', 'must be a string').notEmpty(),
...
assetsRouter.patch(
  ...
  body('*.ownerId', 'must be a string').isString(),
  body('*.ownerContact', 'must be a string').isString(),
  body('*.appraisedValue', 'must be a number').isNumeric(),
  async (req: Request, res: Response) => {
    ...
    const newOwnerContact = req.body[0].ownerContact;
    const newAppraisedValue = req.body[0].appraisedValue;
