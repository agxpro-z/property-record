...
CHAINCODE_PATH=${CHAINCODE_PATH:-../property-transfer}
...
deployChaincode
pushd ../property-transfer/application-gateway-go
...
deployChaincode
pushd ../property-transfer/application-gateway-typescript
npm install
...
deployChaincode
pushd ../property-transfer/application-gateway-javascript
npm install
print "Start application"
npm start
popd
...
deployChaincode
pushd ../property-transfer/application-gateway-java
