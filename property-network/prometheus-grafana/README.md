...
5. Deploy a chaincode (i.e. "./network.sh deployCC -ccn property-cc -ccp ../property-record/chaincode-typescript -ccl typescript"), start using the test-network and use the Grafana dashboard to analyse and assess your network performances.
