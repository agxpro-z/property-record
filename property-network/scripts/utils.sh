...
function printHelp() {
  ...
  if [ "$USAGE" == "prereq" ]; then
    ...
    println "    -c <channel name> - Name of channel to create (defaults to \"property-channel\")"
    ...
    println
    println " Examples:"
    println "   network.sh up createChannel -ca -c property-channel -s couchdb "
    println "   network.sh up createChannel -bft -c property-channel -s couchdb "
    ...
    println
    println " Examples:"
    println "   network.sh deployCC -ccn property-cc -ccp ../property-record/chaincode-javascript/ ./ -ccl javascript"
    ...
    println
    println " Examples:"
    println "   network.sh deployCCAAS  -ccn property-ccj -ccp ../property-record/chaincode-java"
    println "   network.sh deployCCAAS  -ccn property-cct -ccp ../property-record/chaincode-typescript -ccaasdocker false"
  elif [ "$USAGE" == "cc" ] ; then
    println "Usage: "
    ...
    println "   network.sh cc package -ccn property-cc -ccp chaincode/property-record/go -ccv 1.0.0 -ccl go"
    ...
    println "      \033[0;32mdeployCC\033[0m - Deploy a chaincode to a channel (defaults to property-record)"
