...
CHANNEL_NAME=${1:-"property-channel"}
CC_NAME=${2}
CC_SRC_PATH=${3}
...
if [ -z "$CC_NAME" ] || [ "$CC_NAME" = "NA" ]; then
  fatalln "No chaincode name was provided. Valid call example: ./network.sh deployCCAS -ccn property-cc -ccp ../property-record/chaincode-typescript "

# User has not provided a path
elif [ -z "$CC_SRC_PATH" ] || [ "$CC_SRC_PATH" = "NA" ]; then
  fatalln "No chaincode path was provided. Valid call example: ./network.sh deployCCAS -ccn property-cc -ccp ../property-record/chaincode-typescript "
