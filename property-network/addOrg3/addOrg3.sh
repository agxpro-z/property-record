...
function printHelp () {
  ...
  echo "    -c <channel name> - test network channel name (defaults to \"property-channel\")"
  ...
  echo "	addOrg3.sh up"
  echo "	addOrg3.sh up -c property-channel -s couchdb"
...
#default for delay
CLI_DELAY=3
# channel name defaults to "property-channel"
